...
class __TwigTemplate_102fd4ce66816adbca2acb89c298480c extends Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["event"]) {
                ...
                if ( !CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", true, true, false, 111)) {
                    ...
                    if (CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "subject", [], "any", true, true, false, 124)) {
                        ...
                        (((CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "getSubject", [], "method", true, true, false, 126) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "getSubject", [], "method", false, false, false, 126)))) ? (yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "getSubject", [], "method", false, false, false, 126), "html", null, true)) : (yield "(empty)"));
                        yield "</h2>
                                                    ";
...
(isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 138, $this->source); })()), "headers", [], "any", false, false, false, 138), "has", ["from"], "method", false, false, false, 138)) {
                        // line 139
                        yield "                                                                <pre class=\"prewrap\">";
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 139), "get", ["from"], "method", false, true, false, 139), "bodyAsString", [], "method", true, true, false, 139)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 139), "get", ["from"], "method", false, true, false, 139), "bodyAsString", [], "method", false, false, false, 139), "(empty)")) : ("(empty)")), "html", null, true);
                        yield "</pre>
                                                            ";
                    } else {
                        // line 141
...
(isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 148, $this->source); })()), "headers", [], "any", false, false, false, 148), "has", ["to"], "method", false, false, false, 148)) {
                        // line 149
                        yield "                                                                <pre class=\"prewrap\">";
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 149), "get", ["to"], "method", false, true, false, 149), "bodyAsString", [], "method", true, true, false, 149)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["message"] ?? null), "headers", [], "any", false, true, false, 149), "get", ["to"], "method", false, true, false, 149), "bodyAsString", [], "method", false, false, false, 149), "(empty)")) : ("(empty)")), "html", null, true);
                        yield "</pre>
                                                            ";
                    } else {
                        // line 151
...
";
    ...
    {
        return array (  589 => 242,  580 => 238,  571 => 232,  562 => 226,  557 => 223,  550 => 219,  545 => 216,  542 => 215,  524 => 211,  519 => 209,  516 => 208,  498 => 207,  492 => 203,  489 => 201,  486 => 199,  484 => 198,  479 => 194,  476 => 193,  473 => 192,  467 => 188,  464 => 186,  461 => 184,  459 => 183,  446 => 172,  439 => 167,  436 => 166,  433 => 165,  431 => 164,  429 => 163,  422 => 158,  414 => 157,  410 => 156,  405 => 153,  401 => 151,  395 => 149,  393 => 148,  388 => 147,  386 => 146,  384 => 145,  380 => 143,  376 => 141,  370 => 139,  368 => 138,  363 => 137,  361 => 136,  359 => 135,  354 => 132,  350 => 130,  344 => 128,  342 => 127,  337 => 126,  335 => 125,  333 => 124,  325 => 118,  323 => 117,  317 => 114,  314 => 113,  312 => 112,  310 => 111,  304 => 108,  301 => 107,  298 => 106,  294 => 105,  290 => 103,  286 => 102,  278 => 97,  270 => 92,  265 => 89,  259 => 85,  257 => 84,  252 => 81,  249 => 80,  239 => 79,  227 => 76,  221 => 73,  218 => 72,  216 => 71,  210 => 68,  206 => 67,  203 => 66,  200 => 65,  190 => 64,  143 => 28,  133 => 27,  119 => 23,  116 => 22,  109 => 19,  102 => 15,  98 => 13,  96 => 12,  93 => 11,  86 => 9,  83 => 8,  80 => 7,  78 => 6,  75 => 5,  72 => 4,  62 => 3,  39 => 1,);
    }
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "C:\\Users\\lenovo\\task1\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\mailer.html.twig");
    }
}
